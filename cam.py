...
def get_params():
    params = {
        # 'weight': r"D:\Yolov11\ultralytics\runs\detect\循序渐进改进\Baseline\weights\best.pt",
        'weight': r'D:\Yolov11\ultralytics\runs\detect\循序渐进改进\-P5 + 2 C3k2A  + 1 WeightConcat + 3 Vov\weights\best.pt',  # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'GradCAM',
...
if __name__ == '__main__':
    ...
    model(r"D:\Yolov11\datasets\for test\images\val\3107.jpg", 'result')
